...
export default function RegisterAgentPage() {
  ...
  return (
    <div className="mx-auto max-w-md px-4 py-12">
      <h1 className="text-2xl font-semibold text-stone-800">Agent registration</h1>
      <p className="mt-1 text-sm text-stone-500">List your hostels after identity verification</p>
      <form onSubmit={handleSubmit} className="mt-8 space-y-4">
        ...
        <div>
          <label htmlFor="agencyName" className="block text-sm font-medium text-stone-700">Agency / business name (optional)</label>
          <input
            id="agencyName"
            name="agencyName"
            type="text"
